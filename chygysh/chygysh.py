...
from project.chygysh.source import (
    texts,
    labels,
    label_mapping
)
...
def get_chygysh():
    ...
    model.add(LSTM(32))
    model.add(Dense(6, activation='softmax'))  # 6 - жондомолор
...
def get_chygysh_predict(input_text, padded_sequences, model):
    ...
    print(f'Чыгыш : {input_text[0]+predicted_labels[0]}')
